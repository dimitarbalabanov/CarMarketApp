...
namespace CarMarket.Data.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUsersBookmarkListings",
                columns: table => new
                {
                    UserId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsersBookmarkListings", x => new { x.UserId, x.ListingId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersBookmarkListings_ListingId",
